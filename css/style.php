...
/* ===============================
   UTILITY CLASSES
=============================== */
.rounded { border-radius: var(--base-padding); }
.shadow { box-shadow: 0 0.125rem 0.375rem var(--shadow-color); }
...
padding: 0.625rem;
background: linear-gradient(120deg, #3B82F6 0%, #A855F7 100%);
...
.postcontent button {border-radius: 0.3125rem;float: right;background: var(--button-primary-bg);padding: 0.3125rem;margin: 0.125rem;}
...
.feedposts > div {display: inline-table;min-width: 15.625rem;box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.08);max-width: 21.875rem;flex-shrink: 0;}
...
.like-count{color:var(--color-text-inverse)}
.form-alert {
  margin: 1rem auto;
