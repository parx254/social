<?php
  ...
  $title = "Chicago | Social Destinations";      // (1) Set the title
  $description = 'Discover Chicago';           // (2) Set the description
  $city = 'Chicago';                  // (3) Set the city
  $keywords = 'Chicago, Travel, Trips, Travel Tips, Adventures, Events, Holidays, Social Destinations, Social, Destinations';          // Set the keywords
