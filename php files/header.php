...
echo '
<li class="not-active">
  <a href="login.php"><i class="fad fa-sign-in" aria-hidden="true"></i>
  <div class="tooltip">
    Login
  </div>
</a>
...
echo '
<li class="active">
  <a href="my-profile.php"><i class="fad fa-user-circle" aria-hidden="true"></i>
  <div class="tooltip">
    Profile
  </div>
</a>
...
echo '
<li class="active">
  <a href="feed.php"><i class="fad fa-users" aria-hidden="true"></i>
  <div class="tooltip">
    Feed
  </div>
</a>
...
echo '
<li class="active">
  <a href="messages.php"><i class="fad fa-comments" aria-hidden="true"></i>
  <div class="tooltip">
    Messages
  </div>
</a>
