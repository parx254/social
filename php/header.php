        ...
        <ul id="menu">
          ...
          <?php
            if (!isset($_SESSION['username']) || empty($_SESSION['username'])) {
              echo '<li class="not-active"><a href="login.php"><i class="fad fa-sign-in" aria-hidden="true"></i><div class="tooltip">Login</div></a></li>';
            } else {
              if ($activePage == 'profile') {
                echo '<li class="active"><a href="my-profile.php"><i class="fad fa-user-circle" aria-hidden="true"></i><div class="tooltip">Profile</div></a></li>';
              } else {
                echo '<li class="not-active"><a href="my-profile.php"><i class="fad fa-user-circle" aria-hidden="true"></i><div class="tooltip">Profile</div></a></li>';
              }

              if ($activePage == 'feed') {
                echo '<li class="active"><a href="feed.php"><i class="fad fa-users" aria-hidden="true"></i><div class="tooltip">Feed</div></a></li>';
              } else {
                echo '<li class="not-active"><a href="feed.php"><i class="fad fa-users" aria-hidden="true"></i><div class="tooltip">Feed</div></a></li>';
              }

              if ($activePage == 'message') {
                echo '<li class="active"><a href="inbox.php"><i class="fad fa-comments" aria-hidden="true"></i><div class="tooltip">Messages</div></a></li>';
              } else {
                echo '<li class="not-active"><a href="inbox.php"><i class="fad fa-comments" aria-hidden="true"></i><div class="tooltip">Messages</div></a></li>';
              }
            }
          ?>
